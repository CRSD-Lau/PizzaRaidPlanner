...
add("NoGapShaman","SHAMAN",263,10500,"dps"); add("FeralDruid","DRUID",103,9500,"dps"); add("RetPaladin","PALADIN",70,9000,"dps"); add("RetPaladinTwo","PALADIN",70,8500,"dps"); add("RogueLow","ROGUE",259,8000,"dps")
...
assert(slots.M1=="RetPaladin" and slots.M2=="RetPaladinTwo" and slots.M3=="PumpDK" and slots.M4=="NoGapShaman","M1/M2 reserve Retribution Vengeance uptime before the M3/M4 pump and mobility heuristic")
assert(slots.M5=="SprintRogue" and slots.M6=="ChargeWarrior" and slots.M7=="FeralDruid" and slots.M8=="RogueLow","normal eight-player recovery footprint completes the center-out M5-M8 pairs")
assert(slots.M9==nil and slots.M10==nil,"M9 and M10 remain unused with eight melee-position occupants")
...
assert(cell(1,4)=="RetPaladin" and cell(2,4)=="RetPaladinTwo" and cell(3,4)=="PumpDK" and cell(4,4)=="NoGapShaman","Retribution-first protected melee slots survive A1:F10 worksheet block")
assert(cell(9,4)=="—" and cell(10,4)=="—","eight-player worksheet marks unused M9 and M10 so stale names are cleared")
assert(worksheet:find("VALANAR ACTIVE",1,true) and worksheet:find("Festergut DPS",1,true) and worksheet:find("Protected M1%-M4",1,false) and worksheet:find("Recovery M5%-M8",1,false),"BPC worksheet identifies Valanar phase and explains center-out melee placement")
...
assert(slots.M9 and slots.M10,"M9 and M10 activate only for ninth and tenth melee-position occupants")
print("test_bpc: OK")
